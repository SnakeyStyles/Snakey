// source: https://github.com/kylepaulsen/ResourceOverride/blob/master/src/background/match.js
...
let Match = {
  ...
  match(pattern, str) {
    "use strict";
    var patternTokens = Match.tokenize(pattern);
    var freeVars = {};
    var varGroup;
    var strParts = str;
  ...
  replaceAfter(str, idx, match, replace) {
    "use strict";
    return str.substring(0, idx) + str.substring(idx).replace(match, replace);
  },
  matchReplace(pattern, replacePattern, str) {
    "use strict";
    var matchData;
    ...
    starGroups.forEach(function(starGroup) {
      ...
      replacePattern = Match.replaceAfter(replacePattern, currentStarGroupIdx, starGroup, freeVar);
